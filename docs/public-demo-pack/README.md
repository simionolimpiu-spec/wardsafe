...
- `clinical-safety-case-outline.md` - first-pass clinical safety case outline and 10-row hazard log, not yet independently reviewed.
- `stakeholder-demo-pack.md` - concise NHS-facing stakeholder demo pack.

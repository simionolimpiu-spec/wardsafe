...
| SNOMED CT coding | RED | Simulated events/observations not SNOMED-coded; additive task scoped for Mia's codex (SF-220) |
...
3. SF-220 SNOMED coding of fixtures + FHIR mapping assessment (Domain 4) — scoped for Mia's codex.

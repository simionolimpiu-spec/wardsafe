...
- **SNOMED CT** — mandatory clinical terminology. Simulated observations/events should carry real SNOMED codes even for fictional patients (task SF-222): near-zero cost now, makes every fixture portable later.
...
**Now (zero external dependencies):** SNOMED-code fixtures (SF-222); FHIR mapping assessment doc; identity seam (SF-207); free developer account; keep hazard log and DTAC self-assessment current.
